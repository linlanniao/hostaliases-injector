...
metadata:
  annotations:
    sre-mutator.rootcloud.info/job-recreate-if-changed: image
  labels:
...
metadata:
  annotations:
    sre-mutator.rootcloud.info/job-recreate-if-changed: image,env
  labels:
    app.oam.dev/revision: test-job-v1
  name: test-job-latest
  namespace: default
...
metadata:
  annotations:
    sre-mutator.rootcloud.info/job-recreate-if-changed: env
  labels:
    app.oam.dev/revision: test-job-v1
  name: test-job-latest
  namespace: default
